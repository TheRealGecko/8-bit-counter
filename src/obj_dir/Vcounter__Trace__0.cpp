...
void Vcounter___024root__trace_chg_0_sub_0(Vcounter___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,(vlSelfRef.eight_bit_counter_tb__DOT__clk));
        bufp->chgBit(oldp+1,(vlSelfRef.eight_bit_counter_tb__DOT__rst));
        bufp->chgBit(oldp+2,(vlSelfRef.eight_bit_counter_tb__DOT__out_ena));
        bufp->chgCData(oldp+3,(vlSelfRef.eight_bit_counter_tb__DOT__val),8);
    }
    bufp->chgBit(oldp+4,(vlSelfRef.eight_bit_counter_tb__DOT__set_val_ena));
    bufp->chgCData(oldp+5,(((IData)(vlSelfRef.eight_bit_counter_tb__DOT__dut__DOT__count) 
                            & (- (IData)((IData)(vlSelfRef.eight_bit_counter_tb__DOT__out_ena))))),8);
    bufp->chgCData(oldp+6,(vlSelfRef.eight_bit_counter_tb__DOT__dut__DOT__count),8);
}
