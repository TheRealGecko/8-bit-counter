...
VL_ATTR_COLD void Vcounter___024root__trace_init_sub__TOP__0(Vcounter___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_PUSH_PREFIX(tracep, "eight_bit_counter_tb", VerilatedTracePrefixType::SCOPE_MODULE, 0, 0);
    ...
    VL_TRACE_DECL_BIT(tracep,c+2,0,"out_ena",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+3,0,"val",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 7,0);
    ...
    VL_TRACE_DECL_BIT(tracep,c+2,0,"out_ena",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+3,0,"val",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 7,0);
...
VL_ATTR_COLD void Vcounter___024root__trace_full_0_sub_0(Vcounter___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+0,(vlSelfRef.eight_bit_counter_tb__DOT__clk));
    bufp->fullBit(oldp+1,(vlSelfRef.eight_bit_counter_tb__DOT__rst));
    bufp->fullBit(oldp+2,(vlSelfRef.eight_bit_counter_tb__DOT__out_ena));
    bufp->fullCData(oldp+3,(vlSelfRef.eight_bit_counter_tb__DOT__val),8);
    bufp->fullBit(oldp+4,(vlSelfRef.eight_bit_counter_tb__DOT__set_val_ena));
    bufp->fullCData(oldp+5,(((IData)(vlSelfRef.eight_bit_counter_tb__DOT__dut__DOT__count) 
                             & (- (IData)((IData)(vlSelfRef.eight_bit_counter_tb__DOT__out_ena))))),8);
    bufp->fullCData(oldp+6,(vlSelfRef.eight_bit_counter_tb__DOT__dut__DOT__count),8);
}
