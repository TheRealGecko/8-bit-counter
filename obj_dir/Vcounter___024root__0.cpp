    ...
    // Body
    {
        ...
        vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                        ((vlSelfRef.__VdlySched.awaitingCurrentTime() 
                                                          << 3U) 
                                                         | ((((IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst) 
                                                              & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__rst__0))) 
                                                             << 1U) 
                                                            | ((IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__clk) 
                                                               & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__clk__0)))))));
        vlSelfRef.__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__clk__0 
            = vlSelfRef.tt_um_eight_bit_counter_tb__DOT__clk;
        vlSelfRef.__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__rst__0 
            = vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst;
    }
...
bool Vcounter___024root___eval_inact(Vcounter___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT("src/counter_tb.v", 3, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
            ...
            if ((3ULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    vlSelfRef.tt_um_eight_bit_counter_tb__DOT__dut__DOT__count 
                        = ((IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst)
                            ? 0U : (0x000000ffU & ((IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__set_val_ena)
                                                    ? (IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__val)
                                                    : 
                                                   ((IData)(1U) 
                                                    + (IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__dut__DOT__count)))));
                }
            }
            if ((0x000000000000000cULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    // Inlined CFunc: _nba_sequent__TOP__1
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v0) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v0 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__out_ena = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v1) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v1 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__out_ena = 1U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v0) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v0 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__clk = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v1) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v1 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__clk 
                            = vlSelfRef.__VdlyVal__tt_um_eight_bit_counter_tb__DOT__clk__v1;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v0) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v0 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__val = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v1) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v1 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__val = 5U;
                    }
                }
            ...
            if ((0x000000000000000cULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v0) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v0 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v1) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v1 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst = 1U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v2) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v2 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__rst = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v0) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v0 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__set_val_ena = 0U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v1) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v1 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__set_val_ena = 1U;
                    }
                    if (vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v2) {
                        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v2 = 0U;
                        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__set_val_ena = 0U;
                    }
                }
            }
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__0(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v0 = 1U;
    while (true) {
        co_await vlSelfRef.__VdlySched.delay(0x0000000000001388ULL, 
                                             ...
                                             22);
        vlSelfRef.__VdlyVal__tt_um_eight_bit_counter_tb__DOT__clk__v1 
            = (1U & (~ (IData)(vlSelfRef.tt_um_eight_bit_counter_tb__DOT__clk)));
        vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v1 = 1U;
    }
    co_return;
}
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__1(Vcounter___024root* vlSelf) {
    ...
    co_await vlSelfRef.__VdlySched.delay(0x00000000002dc6c0ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         26);
    VL_FINISH_MT("src/counter_tb.v", 27, "");
    co_return;
}
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__2(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v0 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x000000000000a410ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         32);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v1 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x0000000000001388ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         34);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v2 = 1U;
    co_return;
}
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__3(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v0 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x00000000000055f0ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         40);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v1 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x0000000000001388ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         42);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v2 = 1U;
    co_return;
}
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__4(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v0 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x0000000000001b58ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         48);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v1 = 1U;
    co_return;
}
...
VlCoroutine Vcounter___024root___eval_initial__TOP__Vtiming__5(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v0 = 1U;
    co_await vlSelfRef.__VdlySched.delay(0x0000000000002ee0ULL, 
                                         nullptr, "src/counter_tb.v", 
                                         54);
    vlSelfRef.__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v1 = 1U;
    co_return;
}
