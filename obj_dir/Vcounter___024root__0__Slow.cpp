...
VL_ATTR_COLD void Vcounter___024root___eval_static(Vcounter___024root* vlSelf) {
    ...
    // Body
    {
        ...
        vlSelfRef.tt_um_eight_bit_counter_tb__DOT__dut__DOT__count = 0U;
    }
...
VL_ATTR_COLD void Vcounter___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @(posedge tt_um_eight_bit_counter_tb.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @(posedge tt_um_eight_bit_counter_tb.rst)\n");
    }
...
VL_ATTR_COLD void Vcounter___024root___ctor_var_reset(Vcounter___024root* vlSelf) {
    ...
    vlSelf->tt_um_eight_bit_counter_tb__DOT__clk = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15768916834340133717ull);
    vlSelf->tt_um_eight_bit_counter_tb__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7784598990803833942ull);
    vlSelf->tt_um_eight_bit_counter_tb__DOT__set_val_ena = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9009552458963932840ull);
    vlSelf->tt_um_eight_bit_counter_tb__DOT__out_ena = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1560881094446271364ull);
    vlSelf->tt_um_eight_bit_counter_tb__DOT__val = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 10338156828578113143ull);
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v0 = 0;
    vlSelf->__VdlyVal__tt_um_eight_bit_counter_tb__DOT__clk__v1 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__clk__v1 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v0 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v1 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__rst__v2 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v0 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v1 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__set_val_ena__v2 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v0 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__out_ena__v1 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v0 = 0;
    vlSelf->__VdlySet__tt_um_eight_bit_counter_tb__DOT__val__v1 = 0;
    ...
    vlSelf->__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__clk__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__tt_um_eight_bit_counter_tb__DOT__rst__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
